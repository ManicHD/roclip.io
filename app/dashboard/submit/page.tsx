                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            ...
                            <div className="text-sm flex items-center gap-2">
                                ...
                                <div className="flex items-center gap-2">
                                    {selectedCampaignData.allowedPlatforms.split(",").map((p) => {
                                        ...
                                        // SHORT-FORM DISABLED: Only show YouTube badge
                            ...
                            {selectedCampaignData.minViewsLong && (
                                <div className="text-sm">
                                    ...
                                    <span className="text-white ml-2">
                                        {selectedCampaignData.minViewsLong.toLocaleString()}
                                    </span>
                                </div>
                            )}
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Paste your YouTube video URL (long-form only, no Shorts). You can submit up to {MAX_VIDEOS} videos at once.
                        </p>
                    </div>
