        ...
        <footer className="border-t border-white/5 bg-black py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8">
                ...
                <div className="flex gap-4 sm:gap-5">
                    <Link href="#" className="text-gray-500 hover:text-white transition-colors duration-200 p-2 hover:bg-white/5 rounded-lg">
                        <Twitter className="h-4 w-4 sm:h-5 sm:w-5" />
                    </Link>
                    <Link href="https://discord.gg/RJ5WuJVkc9" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors duration-200 p-2 hover:bg-white/5 rounded-lg">
                ...
                <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-gray-500">
                    ...
                    <Link href="https://discord.gg/RJ5WuJVkc9" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors duration-200">Contact</Link>
                </div>
            </div>
        </footer>
    );
